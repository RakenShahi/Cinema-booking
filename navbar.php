...
<script>
  ...
  function redirect () {
    window.location.href = 'register.php?name=' + name + '&email=' + mail + '&gender=' + gender;
  }
  ...
  <div class="navbar-header">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php if(isset($_SESSION['admin'])){ ?>
        ...
        <li><a href="Realtime.php">Real time booking</a></li>
        <li><a href="transactiondetails.php">Transaction Details</a></li>

        
      <?php } ?>
    
     <?php if(isset($_SESSION['accountant'])){ ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="Loginmodalbox">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <FORM method="POST" action="signin.php">
          ...
          <a href="forgot.php">Forgot your Password? </a><input type=submit class="btn btn-info" value="Submit">
  ...
  onlogin="checkLoginState();redirect();">
</fb:login-button>
               </FORM>
