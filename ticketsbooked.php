...
if (r == true) { alert('Tickets reserved.');
...
<table class="table table-condensed">
 ...
 <td><?php echo $ticket['no_of_seats']; ?></td>
  <td><?php echo "<a href='cancelbyadmin.php?booking_id=".$ticket['booking_id']."&user_id=".$ticket['user_id']."' class='btn btn-primary' role='button' data-dismiss='alert' onclick='cancel()'>Cancel Ticket</a>" ?></td>
 <td> <?php echo "<a href='reserved.php?booking_id=".$ticket['booking_id']."&user_id=".$ticket['user_id']."'class='btn btn-primary' role='button' onclick='cancel()' >Sold</a>" ?> </td>
 </tr>
 <?php }?>
</table>
