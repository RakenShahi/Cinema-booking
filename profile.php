...
$decrypted = decryptIt($data['password']);
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <?php if (!$data['user_image']){?>

                <img src="image/default.png" style="width: 130; height:130" class="img-circle">

               <?php  }

                if ($data['user_image']) { ?> <img src="data:image/jpeg;base64, <?php echo $data['user_image'];}?> <?php if ($data['user_image']) { ?> "style="width: 130; height:130" class="img-circle"/> <?php } ?> </div>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
 				...
 				<div class="form-group">
    				...
    				<input type="password"  name="Password" value="<?php echo $decrypted;?>">
