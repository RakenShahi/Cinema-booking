...
<div class="demo">
		...
		<form method="POST" action="adminbooking.php?a_id=<?php echo $movie['audiorium_id'];?>" id="bookform" name="bookform">
...
$(document).ready(function(){
    ...
    $('#selected-seats li').each(function (i) {
	    ...
	    if (counter>100)
	    	{ alert("You can only book 100 tickets. Thank you!!!");
	    		event.preventDefault();
	    	}
	    	else{
...
<script type=text/javascript>
				...
				var res = sum.split("+");
				var seat_sold = "<?php echo $seat_sold; ?>";
				var res1 = seat_sold.split("+");
					$(document).ready(function(){
						var i;
						...
						for (i = 1; i < res1.length; ++i) {
    						   $("#"+res1[i]).removeClass('unavailable').addClass('sold');
